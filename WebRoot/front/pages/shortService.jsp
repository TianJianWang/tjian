...
<body>
    ...
    <div class="bigtype">	<a
							href="service/service_queryFrontBigTypeShortService?nowPage=1&type_id=<s:property
								value="type_id" />"
							target="_self"><s:property value="bigTypeShortService.bigtype_name" />
						</a></div>
    <div class="smalltype">
    <s:iterator value="bigTypeShortService.smallTypelist" status="st">
						
							<a
								href="service/service_queryFrontSmallTypeShortService?nowPage=1&type_id=<s:property
								value="smalltype_id" />"
								target="_blank" style="margin-right: 30px"><s:property value="smalltype_name" /> </a>
	...
	border-top-style: solid; clear: both;"></div>
				<div class="small" style=" margin-left:0px ;text-align: left;width: 172px; ">
					<div class="tinyimg">
						<a
