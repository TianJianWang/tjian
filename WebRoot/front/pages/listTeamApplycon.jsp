...
value="applyList" var="list">
			 <tr>
   <td> <s:property value="#list.user.realname"/>

 </td>
	<td><s:property 

value="#list.team.name"/> </td>
    <td><s:property 

value="#list.time"/></td>


    <td><a href="ming/team_listTeamApplyByTeam?team_id=<s:property value="#list.team.team_id"/>">详细信息</a></td>
  </tr>
