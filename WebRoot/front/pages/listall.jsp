...
<div class="bg">
  <div class="main">
    ...
    <ul class="project-one">
                    ...
                    <li class="project-function"> <a href="/forums/project-297159" title="此项目有1个话题" class="project-p-on">话题：1</a> <a href="/projects/297159/backers" title="11用户支持此项目" class="project-g-on">支持：11</a> <a href="/projects/discover/10_0_0_0" class="project-g-failure">
                   
                    <s:if test='"#list.pro.pro_wantedMoney">10234'>筹资成功</s:if>
                    <s:else>筹资失败</s:else>
                    </a> </li>
                    <li class="project-list-stats">
                      ...
                      <div class="projectstats">
                        ...
                        <p class="widthd"><strong><s:date name="#list.pro_endDate" nice="ture"/></strong>结束时间</p>
                      </div>
                    </li>
                  </ul>
