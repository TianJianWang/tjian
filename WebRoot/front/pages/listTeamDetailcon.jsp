...
<div class="ic">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text"  name="team.user.nickname" value="${team.user.realname }"  readonly="readonly"  class="form-control" id="input2" placeholder="发起人">
    </div>
  </div>
  <br><br>
  <div class="form-group">
    <label for="input1" class="col-sm-2 control-label"><a href="ming/pre_listProjectSalepreDetial?project.pro_id=${team.project.pro_id }">团队项目</a></label>
    <div class="col-sm-10">
    <a href="ming/pre_listProjectSalepreDetial?project.pro_id=${team.project.pro_id }">
    <input type="text"  name="team.project.pro_title" value="${team.project.pro_title }"  readonly="readonly"  class="form-control" id="input1"  placeholder="发起项目"></a>
    </div>
  </div>
  <br><br>
  <div class="form-group">
