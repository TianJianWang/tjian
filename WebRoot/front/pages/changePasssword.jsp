...
<body id="page1" onload="crateCode();">
a<!-- header -->
	<div class="bg">
		<div class="main">
			<header>
...
function checkPw(){
	...
	var pe2=document.getElementById("input2").value; 
	if(pw1!=pw2){
         alert("亲，前后密码不一致，检查一下吧.");
	}
	else{
	  window.document.getElementById("checkPwd").value="密码一致！";
	}
}
				...
				<div class="row-3">
					<div class="slider-wrapper">
						<div class="slider">
						  ...
						  <form action="user/UserAction_changePassword" class="form-horizontal" style="background-color: white;width: 950px;height:380px;border-radius:2em;padding-top: 100px;padding-left: 150px" role="form"  enctype="multipart/form-data"  method="post">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="password" class="form-control" name="user.password" id="input1"
										placeholder="Password" style="width: 50%"    value=""/>
								</div>
							</div>
							 <div class="form-group">
								<label for="inputPassword3" class="col-sm-2 control-label">确认密码:</label><span id="checkPwd"></span>
								<div class="col-sm-10">
									<input type="password" class="form-control" name="password2" id="input2"
										placeholder="Password" style="width: 50%"   value="" onblur="checkPw();"/>
								</div>
							</div>
