         ...
         logout:function(){}
				...
				<div class="row-3" >
					<div class="slider-wrapper"  >
						<div class="slider"> 
						  <form action="user/UserAction_addUser" class="form-horizontal"  
						  role="form"  enctype="multipart/form-data" method="post" style="margin-top: 70px;margin-left: 50px;padding-left: 50px">
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="email" class="form-control" name="user.email" id="userEmailId"
										placeholder="请输入可用邮箱" style="width: 50%"  value="" />
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="user.realname" id="passwordId"
										placeholder="请输入密码" style="width: 50%"    value="" onblur="chk();"/>
							 ...
							 <div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="user.realname" id="repasswordId"
										placeholder="请再次输入密码确认" style="width: 50%"    value=""/>
							...
							<div class="form-group"> 
								<div class="col-sm-offset-2 col-sm-10">
									<button type="submit" class="btn btn-default" onclick="recoverDefaultText();">确认提交</button>
								</div>
							</div>
						</form>
