			...
			<link rel="stylesheet" href="css/reset.css" type="text/css"
				...
				<link rel="stylesheet" href="css/style.css" type="text/css"
					...
					<link rel="stylesheet" href="css/layout.css" type="text/css"
						...
						<script src="js/Open_Sans_Light_300.font.js"
...
<body id="page1"
	style="margin-left: auto;margin-right: auto;margin-left: 130px">
		...
		<div class="main">
			...
			<div class="row-1">
				...
				<script type="text/javascript"
					...
					data-appid="101084219" data-redirecturi="http://tjian.org/qq.jsp"
			...
			<div class="row-3">
				<div class="slider-wrapper">
					<div class="slider">
						<div class="ce" align="center">
							<br />
							<br />
							
							<img src="front/images/succ.png" width="199" height="199"  />
					...
					<div class="col-3">
						<div class="indent">
							...
							<div class="wrapper">
								...
								<div class="extra-wrap">
									<div class="indent2">
										预售众筹——且行且珍惜<br /> 同行品鉴——煮酒论英雄<br /> 财务公开——进度全清楚<br />
										服务对接——人靠众人抬<br />
			...
			<div class="row-bot">
				<div class="aligncenter">
					...
					Reserved by <a href="http://www.tjian.org" title="天鉴网"
