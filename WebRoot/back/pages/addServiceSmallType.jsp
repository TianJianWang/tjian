...
<script type="text/javascript" src="back/js/service.js"></script>
 ...
 <s:select name="type.type_up_id"  list="typelist" listKey="type_id" listValue="type_name" label="请选择为那个一级类型添加子类型"></s:select>
 <s:textfield id="type" name="type.type_name" label="请输入子服务类型名字" tip="请输入子服务类型名字"></s:textfield>
 <s:hidden name="type.type_leval" value="2"></s:hidden>
